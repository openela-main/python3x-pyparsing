...
%if %{with doc}
%package -n python%{python3_pkgversion}-pyparsing-doc
Summary:        Documentation for pyparsing python package

%description -n python%{python3_pkgversion}-pyparsing-doc
...
%prep
%setup -q -n %{srcname}-%{srcname}_%{version}
...
%if %{with doc}
%files -n python%{python3_pkgversion}-pyparsing-doc
%license LICENSE
